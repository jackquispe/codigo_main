...
cursos.unshift("React Native"); //agrega un elemento al incio
console.log("unshift", cursos);
cursos[1].unshift("Nextjs"); //agrega un elemento en el array posicion 1 - al incio
...
newCursos.forEach(function (element, incdice) {
  console.log(element, incdice); // Angular, 0
});
